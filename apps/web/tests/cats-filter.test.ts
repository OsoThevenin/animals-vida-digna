...
const makeCat = (overrides: Partial<CatFilterData> = {}): CatFilterData => ({
  ...
  coverImage: { src: '/images/cats/test.jpg', alt: 'Test' },
...
const sampleCats: CatFilterData[] = [
  makeCat({ keystatic_slug: 'luna', name: 'Luna', slug: 'luna', status: 'available', gender: 'female', personality: ['playful', 'affectionate'], featured: true }),
  makeCat({ keystatic_slug: 'michi', name: 'Michi', slug: 'michi', status: 'adopted', gender: 'male', personality: ['calm', 'social'] }),
  makeCat({ keystatic_slug: 'nala', name: 'Nala', slug: 'nala', status: 'available', gender: 'female', personality: ['shy', 'calm'] }),
  makeCat({ keystatic_slug: 'simba', name: 'Simba', slug: 'simba', status: 'treatment', gender: 'male', personality: ['playful', 'curious'] }),
  makeCat({ keystatic_slug: 'cleo', name: 'Cleo', slug: 'cleo', status: 'available', gender: 'male', personality: ['independent'], featured: true }),
];
